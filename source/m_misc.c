...
*/
	char flname[256];
	sprintf(flname, "ux0:/data/vitaStrife/%s", path);
    sceIoMkdir(flname, 0777);
//#endif
}
...
boolean M_FileExists(char *filename)
{
	...
	char flname[256];
	sprintf(flname, "ux0:/data/vitaStrife/%s", filename);
    fstream = fopen(flname, "r");
...
boolean M_WriteFile(char *name, void *source, int length)
{
	...
	char flname[256];
	sprintf(flname, "ux0:/data/vitaStrife/%s", name);
    handle = fopen(flname, "wb");
