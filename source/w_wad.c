...
void W_Profile (void)
{
    ...
    f = fopen ("ux0:/data/vitaStrife/waddump.txt","w");
    name[8] = 0;
...
void W_CheckSize(void)		// FOR THE PSP SOURCE PORT (TAKEN FROM PSPHEXEN BUT HEAVILY MODIFIED)
{
    ...
    file_strife0_wad = fopen("ux0:/data/vitaStrife/strife0.wad", "r");
...
//	goto end;
    ...
    file_strife1_wad = fopen("ux0:/data/vitaStrife/strife1.wad", "r");
...
//    if(disable_voices == 0 && (STRIFE_1_0_REGISTERED || STRIFE_1_X_REGISTERED))
    {
    	...
    	file_voices_wad = fopen("ux0:/data/vitaStrife/voices.wad", "r");
